class BarCluster {
    ...
    addBar(name, value, maxValue, width, height, primaryColor = "green", secondaryColor = "red") {
        ...
        let bar = new Bar(this, name, value, maxValue, this.model.position.x, baseY + (height * this.bars.length),
    ...
    update() {
        this.bars.forEach(bar => {
           ...
           bar.position.y = baseY + (bar.height * this.bars.length);
        });
    }
